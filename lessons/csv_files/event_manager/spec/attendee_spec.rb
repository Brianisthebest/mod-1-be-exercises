...
describe Attendee do
  ...
  describe '#display' do
    it 'displays the id, name, and zipcode' do
  ...
  describe '#clean_zipcode' do
    it 'cleans up the zipcode base on the input' do
      expect(@person_1.clean_zipcode(20010)).to eq("20010")
      expect(@person_2.clean_zipcode(7306)).to eq("07306")
      expect(@person_3.clean_zipcode(nil)).to eq("00000")
      expect(@person_4.clean_zipcode(21230)).to eq("21230")
    end
  end
end
