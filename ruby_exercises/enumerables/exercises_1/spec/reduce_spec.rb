RSpec.describe 'reduce' do
  ...
  xit 'capitalize key words in phrase' do
    ...
    result = keywords.reduce('one fish two fish red fish blue fish') do |sentence, word2|
    end
  ...
  it 'divides 560 by a bunch of numbers' do
    ...
    result = numbers.reduce(560) do |total, num|
      total / num
    end
  ...
  it 'subtract smallest values from 100' do
    ...
    result = elements.reduce(100) do |total, num|
      total - num.min
    end
  ...
  it 'adds all second values together' do
    ...
    # initial value is 0
    result = elements.reduce(0) do |tot, array|
      tot + array[1]
    end
