RSpec.describe 'reject' do
  ...
  it 'removes vowels' do
    ...
    remaining = letters.reject do |letter|
      ...
      # letter.include?('a') || letter.include?('y') || letter.include?('o') || letter.include?('u') || letter.include?('i') || letter.include?('e') || letter.include?('y')
    end
  ...
  it 'remove animals starting with a vowel' do
    ...
    remaining = animals.reject do |animal|
      ...
      # animal.start_with?("a") || animal.start_with?("e") || animal.start_with?("i") || animal.start_with?("o") || animal.start_with?("u")
    end
  ...
  it 'remove arrays' do
    ...
    remaining = elements.reject do |ele|
      ele.class == Array
    end
